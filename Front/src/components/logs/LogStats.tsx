    ...
    <>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-6">
        ...
        >
          ...
          <p className="text-2xl font-semibold text-green-500">{stats?.camera_on ?? 0}</p>
        </div>
        <div
          className="glass-panel rounded-lg border border-border/60 p-4 cursor-pointer hover:bg-muted/20 transition-colors"
        ...
        >
          ...
          <p className="text-2xl font-semibold text-yellow-500">{stats?.camera_off ?? 0}</p>
        </div>
        <div
          className="glass-panel rounded-lg border border-border/60 p-4 cursor-pointer hover:bg-muted/20 transition-colors"
        ...
        >
          ...
          <p className="text-2xl font-semibold text-blue-500">{stats?.user_join ?? 0}</p>
        </div>
        <div
          className="glass-panel rounded-lg border border-border/60 p-4 cursor-pointer hover:bg-muted/20 transition-colors"
        ...
        >
          ...
          <p className="text-2xl font-semibold text-orange-500">{stats?.user_leave ?? 0}</p>
        </div>
        <div
          className="glass-panel rounded-lg border border-border/60 p-4 cursor-pointer hover:bg-muted/20 transition-colors"
        ...
        >
          ...
          <p className="text-2xl font-semibold text-gray-500">{stats?.not_joined ?? 0}</p>
        </div>
      </div>
      <StudentStatusModal
        open={modalOpen}
